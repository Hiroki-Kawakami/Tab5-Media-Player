...
enum {
    ...
    RIFF_ID_INFO = RIFF_FOURCC('I', 'N', 'F', 'O'),
    RIFF_ID_id3  = RIFF_FOURCC('i', 'd', '3', ' '),
    RIFF_ID_ID3  = RIFF_FOURCC('I', 'D', '3', ' '),
    RIFF_ID_INAM = RIFF_FOURCC('I', 'N', 'A', 'M'),
    RIFF_ID_IART = RIFF_FOURCC('I', 'A', 'R', 'T'),
    RIFF_ID_IPRD = RIFF_FOURCC('I', 'P', 'R', 'D'),
    RIFF_ID_ICRD = RIFF_FOURCC('I', 'C', 'R', 'D'),
    RIFF_ID_IPRT = RIFF_FOURCC('I', 'P', 'R', 'T'),
    RIFF_ID_ITRK = RIFF_FOURCC('I', 'T', 'R', 'K'),
