...
| `components/` | project-specific plain-C components (`media_buffer`, `media_tags`, `riff_demux`, `es_audio_demux`, `mkv_demux`, `mp4_demux`, `vdec_common`, `h264_dec`, `mpeg2_dec`, `usb_msc`) |
